...
author:
    name: "[Edith Constantino Rodríguez](https://edithconstantino.github.io)"
...
> Definición: "En el ámbito de la estadística, la mediana (del latín mediānus 'del medio'1​) representa el valor de la variable de posición central en un conjunto de datos ordenados. Se le denota mediana."
...
> Definición: "La moda estadística de un conjunto de datos, se define como el número que está representado más veces dentro de esos datos, es decir, aquel número que presenta una mayor frecuencia absoluta dentro de la muestra."

[Estadisticamente (2022)😁](https://estadisticamente.com/moda-estadistica "Estadisticamente (2022)😁")
